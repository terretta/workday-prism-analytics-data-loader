...
public class FieldTypeEnumSerializer extends StdSerializer<FieldTypeEnum> {

	private static final long serialVersionUID = 7780794328976732502L;

	public FieldTypeEnumSerializer() {
		super(FieldTypeEnum.class);
	}

	public FieldTypeEnumSerializer(Class<FieldTypeEnum> t) {
		super(t);
	}

	@Override
	public void serialize(FieldTypeEnum fieldType, JsonGenerator generator, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		generator.writeStartObject();
		generator.writeFieldName("id");
		generator.writeString(fieldType.getId());
		generator.writeFieldName("descriptor");
		generator.writeString(fieldType.getDescriptor());
